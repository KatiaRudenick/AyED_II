...
int main() {
    ...
    cout << "Contenido del vector usando iterador después de borrar el rango desde el principio: ";
    for (vector<int>::iterator iterador = num.begin(); iterador != num.end(); ++iterador) {
        cout << *iterador << " ";
    }
    cout << endl;
    ...
    cout << "Contenido del vector usando iterador después de eliminar el elemento " << elementoBuscado << ": ";
    for (vector<int>::iterator iterador = num.begin(); iterador != num.end(); ++iterador) {
        cout << *iterador << " ";
    }
    cout << endl;
